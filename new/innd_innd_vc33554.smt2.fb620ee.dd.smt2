...
(assert (= _substvar_109_ (bvand _substvar_112_ _substvar_88_)))
(assert (= _substvar_110_ (bvand _substvar_109_ _substvar_98_)))
(assert (= _substvar_103_ (bvand _substvar_97_ _substvar_110_)))
